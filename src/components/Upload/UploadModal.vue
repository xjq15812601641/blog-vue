...
<script lang="ts">
  ...
  import { useUploadType } from "/@/modules/component-module/upload-module/method/useUploadType";
  import { basicProps } from "/@/modules/component-module/upload-module/variable/uploadProps";
  ...
  import { checkImgType } from "/@/modules/component-module/upload-module/method/checkImgType";
  import { getBase64WithFile } from "/@/modules/component-module/upload-module/method/getBase64WithFile";
  import { isFunction } from "/@/utils/is/is";
  import { createTableColumns } from "/@/modules/component-module/upload-module/method/createTableColumns";
  import { createActionColumn } from "/@/modules/component-module/upload-module/method/createActionColumn";
    ...
    setup(props, { emit }) {
      ...
      function beforeUpload(file: File) {
        ...
        if (maxSize && file.size / 1024 / 1024 >= maxSize) {
          createMessage.error(`只能上传不超过${maxSize}M的文件!`);
          return false;
        }
