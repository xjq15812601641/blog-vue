...
<script lang="ts">
  ...
  import { CollapseTransition } from "/@/modules/component-module/transition-module/variable/transitionVariable";
  ...
  import { isBoolean, isObject } from "/@/utils/is/is";
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const { rootMenuEmitter } = useContext<SimpleRootMenuContextProps>(simple_menu_key);
      ...
      function handleMouseenter() {
        ...
        props.name && (data.isChild = parentGetOpenNames().includes(props.name));
        clearTimeout(data.timeout!);
        data.timeout = setTimeout(() => {
          props.name && parentAddSubmenu(props.name);
        }, DELAY);
      }
        ...
        if (data.timeout) {
          ...
          data.timeout = setTimeout(() => {
            if (isRemoveAllPopup.value) {
              ...
              props.name && parentRemoveSubmenu(props.name);
            }
          }, DELAY);
        }
        if (deepDispatch) {
