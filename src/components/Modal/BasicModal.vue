...
<script lang="ts">
  ...
  import { basic_modal_array } from "/@/modules/component-module/modal-module/variable/modalVariable";
  ...
  import { FullScreen } from "/@/modules/component-module/modal-module/method/fullScreen";
  ...
  export default defineComponent({
    ...
    setup(props, { emit, attrs }) {
      ...
      const { handleFullScreen, getWrapClassName, fullScreenRef } = new FullScreen({
        modalWrapperRef,
        extHeightRef,
