...
<script lang="ts">
  ...
  import { ActionItem } from "/@/modules/component-module/table-module/interface/tableAction/ActionItem";
  ...
  import { isBoolean, isFunction, isString } from "/@/utils/is/is";
  import { ACTION_COLUMN_FLAG } from "/@/modules/component-module/table-module/variable/tableVariable";
